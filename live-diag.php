<?php
// Script to fully overwrite get-image.php with the fixed local version
header('Content-Type: text/plain');

$targetPath1 = __DIR__ . '/gallery/api/get-image.php';
$targetPath2 = __DIR__ . '/api/get-image.php';

$actualPath = false;
if (file_exists($targetPath1)) {
    $actualPath = $targetPath1;
} elseif (file_exists($targetPath2)) {
    $actualPath = $targetPath2;
}
...
file_put_contents($actualPath, $newContent);
echo "Status: SUCCESSFULLY APPLIED FIX!\nOverwrote $actualPath with correct local version.";
?>
